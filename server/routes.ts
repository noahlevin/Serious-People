...
// Prompts imported from ./prompts/analysis/
// ============================================================================
...
// Interview system prompt imported from ./prompts/coaching/
// ============================================================================
...
export async function registerRoutes(
  ...
  app.post("/api/coach-chat/:planId/message", requireAuth, async (req, res) => {
    try {
      ...
      const systemPrompt = buildCoachChatPrompt({
        clientName,
        clientDossier: clientDossier as Record<string, unknown> | null,
        coachingPlan: coachingPlan as Record<string, unknown> | null,
        primaryRecommendation,
        coachNoteContent: plan.coachNoteContent,
...
`
  ...
  // Module system prompts imported from ./prompts/coaching/
...
`;
  ...
  function generateModulePrompt(
    ...
    if (!moduleInfo) {
      ...
      const basePrompt = getModuleSystemPrompt(moduleNumber);
      if (dossier) {
        return basePrompt + `\n\n${dossierContext}`;
      }
      return basePrompt;

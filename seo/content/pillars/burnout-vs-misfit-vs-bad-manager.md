---
slug: burnout-vs-misfit-vs-bad-manager
title: "Burnout vs. Misfit vs. Bad Manager: A Diagnostic Guide"
description: How to tell if you're burned out, in the wrong role, or working for the wrong person. A diagnostic framework with specific questions and action paths for each scenario.
lede: "You're exhausted, frustrated, and dreading Monday. But before you quit, you need to know what you're actually dealing with—because the fix for burnout is very different from the fix for a toxic boss."
---
...
**Key indicators:**
- You used to love this work, but now you feel nothing
- Weekends don't recharge you anymore
- Small tasks feel overwhelming
- You're making more mistakes than usual
- Your body is signaling distress (sleep issues, headaches, appetite changes)
- You fantasize about a long break more than a different job
- You've been running unsustainably for 6+ months
...
- Rest (real rest, not "working from home")
- Boundary changes (scope reduction, delegation, saying no)
- System changes (if the workload is structural, rest alone won't fix it)
...
**Key indicators:**
- You don't care about the company's mission (and you've tried)
- Your strengths aren't what this role needs
- You're playing a character at work—not yourself
- The work that energizes your colleagues drains you
- You keep getting feedback that feels like "be someone else"
- Success in this role doesn't excite you
- You've felt this way since early on, not just recently
...
- Honest assessment of what you actually want
- Either an internal move to a better-fitting role
- Or an external move to a company/industry that fits
- Clarity on your non-negotiables for the next role
...
**Key indicators:**
- You were happy here before this manager arrived
- Other people report similar issues with this person
- You get blamed for things outside your control
- You're excluded from decisions you should be part of
- Feedback is vague, contradictory, or delivered through back channels
- You feel surveilled rather than supported
- Your manager takes credit for your work or throws you under the bus
- You've tried to address the relationship and it hasn't helped
...
- Documenting the pattern (for yourself and potentially HR)
- Attempting a direct conversation (one time, clearly)
- Escalation if the behavior crosses lines
- Often: an exit, because bad managers rarely change

## The Overlap Problem

Here's what makes this hard: these conditions feed each other.

- A **bad manager** can cause burnout (through unreasonable demands and lack of support)
- **Burnout** can make you feel like a misfit (because you've lost touch with what you care about)
- Being a **misfit** accelerates burnout (because you're spending energy pretending)
...
- **Clarity on the root cause:** Not just symptoms, but what's actually driving your unhappiness
- **A tailored action plan:** Different paths for burnout, misfit, and bad manager
- **Conversation scripts:** What to say to your manager, HR, or partner depending on the situation
